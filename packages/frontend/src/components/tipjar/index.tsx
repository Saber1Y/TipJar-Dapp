...
const TipJarPage: React.FC<TipJarPageProps> = ({
    ...
    const fetchMetadata = async () => {
      ...
      try {
        ...
        if (address && response.data.owner) {
          setIsOwner(
            address.toLowerCase() === response.data.owner.toLowerCase(),
          );
        }
      } catch (error) {
  ...
  const handleSendTip = async () => {
    ...
    try {
      ...
      toast.success(`Sending ${amountToTip} ETH tip to ${metadata?.name}`);
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <p className="text-gray-600 mb-8">
          The TipJar you're looking for doesn't exist or has been removed.
        </p>
        <button
          onClick={() => router.push("/")}
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          {isOwner && (
            <button
              onClick={() => router.push(`/dashboard/tipjar/${slug}`)}
              className="text-purple-600 hover:text-purple-800 font-medium"
            >
              Manage TipJar
            </button>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="pt-20 px-8 pb-8">
            ...
            {metadata.description && (
              <p className="text-gray-600 mt-3 mb-6">{metadata.description}</p>
            )}
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="flex-1 bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-xs text-gray-500 mt-2 text-center">
                  Plus network fee. Tips go directly to the creator.
                </p>
              </div>
              ...
              <div className="flex-1">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    <p className="mb-1">
                      <span className="font-medium">TipJar Address:</span>{" "}
